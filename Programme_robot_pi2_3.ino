...
// void rampMotorsToTarget(int targetLeft, int targetRight, int targetMotor3, int stepSize) {
//     currentSpeedLeft  += constrain(targetLeft  - currentSpeedLeft,  -stepSize, stepSize);
//     currentSpeedRight += constrain(targetRight - currentSpeedRight, -stepSize, stepSize);
//     currentSpeedMotor3 += constrain(targetMotor3 - currentSpeedMotor3, -stepSize, stepSize);

//     setMotor(MOTOR1_IN1, MOTOR1_IN2, LEDC_CHANNEL_0, currentSpeedRight);
//     setMotor(MOTOR2_IN1, MOTOR2_IN2, LEDC_CHANNEL_1, currentSpeedLeft);
//     setMotor(MOTOR3_IN1, MOTOR3_IN2, LEDC_CHANNEL_2, currentSpeedMotor3);
// }
